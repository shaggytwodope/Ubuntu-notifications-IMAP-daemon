    ...
    def dosync(self):
        ...
        if retcode == 'OK':
            for num in messages[0].split(' '):
                ...
                urllib.request.urlopen("https://caxton.herokuapp.com/api/send",
...
if not hasattr(config, "caxton_token") or not config.caxton_token:
    ...
    code = raw_input_("and enter the code it gives: ")
    fp = urllib.request.urlopen("https://caxton.herokuapp.com/api/gettoken",
